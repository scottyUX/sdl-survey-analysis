...
<body>
  <div class="container">
    <section class="hero">
      ...
      <p>This dashboard summarizes results from the UCSC survey on generative AI usage across the software development lifecycle (SDLC). Values are synced from <code>analysis_dataset_enriched.csv</code> and Phase 3 outputs in this folder.</p>
    ...
    <section class="section grid grid-2">
      ...
      <div class="card">
        ...
        <p>Open the generated PNGs in this folder for publication-ready static figures (same pipeline as the charts below).</p>
      </div>
    </section>
...
{b["table_rows"]}          </tbody>
    ...
    <section class="section grid grid-2">
      <div class="card static-fig">
        ...
        <p class="small">Same regression as Figure 4, exported from Python (<code>au_vs_aum.png</code>).</p>
        <img src="au_vs_aum.png" alt="AU overall vs AUM overall with regression line" />
      </div>
      <div class="card static-fig">
        <h2>Correlation heatmap (pipeline)</h2>
        <p class="small"><code>correlation_heatmap.png</code></p>
